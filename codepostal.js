...
var reg="/"+data.cp+"(.+)/i" ; var rgxp = eval(reg) ; var temp = ClaraIA.reco.match(rgxp) ; console.log(temp)
...
var moment = require('moment');moment.locale('fr');
    ...
    console.log("Clara doit chercher le code postal de "+ville)
    ...
    if(typeof file_content[ville] != 'undefined' && file_content[ville] != "") {
        ...
        request({ 'uri': url}, function(error, response, html) {
            ...
            if(codepostal == "") {
                ...
                ClaraIASpeech("Désolé, je n'ai pas réussi à trouver le code postal de "+ville);
            } else {
